...
<head>
	...
	<!-- Favicon -->
	<link rel="shortcut icon" type="image/x-icon" href="{{ URL::to('themes/admin/assets/img/favicon.png') }}">
	<!-- Bootstrap CSS -->
	...
	<!-- Datatable CSS -->
	<link rel="stylesheet" href="{{ URL::to('themes/admin/assets/css/dataTables.bootstrap4.min.css') }}">
	<!-- Select2 CSS -->
...
<body>
	...
	<div class="main-wrapper">
		...
		<div class="header">
			...
			<div class="header-left">
				<a href="#" class="logo"> <img src="{{ URL::to('themes/admin/assets/img/logo.png') }}" width="40" height="40" alt=""> </a>
			</div>
			<!-- /Logo -->
			...
			<ul class="nav user-menu">
				...
				<li class="nav-item dropdown has-arrow flag-nav">
					<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button"> <img src="{{ URL::to('themes/admin/assets/img/flags/us.png') }}" alt="" height="20"> <span>English</span> </a>
					<div class="dropdown-menu dropdown-menu-right">
						<a href="javascript:void(0);" class="dropdown-item"> <img src="/themes/admin/assets/img/flags/us.png" alt="" height="16"> English </a>
						<a href="javascript:void(0);" class="dropdown-item"> <img src="/themes/admin/assets/img/flags/kh.png" alt="" height="16"> Khmer </a>
						<a href="javascript:void(0);" class="dropdown-item"> <img src="/themes/admin/assets/img/flags/fr.png" alt="" height="16"> French </a>
						<a href="javascript:void(0);" class="dropdown-item"> <img src="/themes/admin/assets/img/flags/es.png" alt="" height="16"> Spanish </a>
						<a href="javascript:void(0);" class="dropdown-item"> <img src="/themes/admin/assets/img/flags/de.png" alt="" height="16"> German </a>
					</div>
				</li>
				<!-- /Flag -->
				<!-- Notifications -->
						...
						<div class="noti-content">
							<ul class="notification-list">
								<li class="notification-message">
									<a href="activities.html">
										<div class="media"> <span class="avatar">
													<img alt="" src="{{ URL::to('themes/admin/assets/img/profiles/avatar-02.jpg') }}">
												</span>
								...
								<li class="notification-message">
									<a href="activities.html">
										<div class="media"> <span class="avatar">
													<img alt="" src="{{ URL::to('themes/admin/assets/img/profiles/avatar-03.jpg') }}">
												</span>
											<div class="media-body">
								...
								<li class="notification-message">
									<a href="activities.html">
										<div class="media"> <span class="avatar">
													<img alt="" src="{{ URL::to('themes/admin/assets/img/profiles/avatar-06.jpg') }}">
												</span>
											<div class="media-body">
								...
								<li class="notification-message">
									<a href="activities.html">
										<div class="media"> <span class="avatar">
													<img alt="" src="{{ URL::to('themes/admin/assets/img/profiles/avatar-17.jpg') }}">
												</span>
											<div class="media-body">
								...
								<li class="notification-message">
									<a href="activities.html">
										<div class="media"> <span class="avatar">
													<img alt="" src="{{ URL::to('themes/admin/assets/img/profiles/avatar-13.jpg') }}">
												</span>
											<div class="media-body">
							...
							<ul class="notification-list">
									...
									<a href="chat.html">
										<div class="list-item">
											<div class="list-left"> <span class="avatar">
														<img alt="" src="{{ URL::to('themes/admin/assets/img/profiles/avatar-09.jpg') }}">
													</span> </div>
								...
								<li class="notification-message">
									<a href="chat.html">
										<div class="list-item">
											<div class="list-left"> <span class="avatar">
														<img alt="" src="{{ URL::to('themes/admin/assets/img/profiles/avatar-05.jpg') }}">
													</span> </div>
								...
								<li class="notification-message">
									<a href="chat.html">
										<div class="list-item">
											<div class="list-left"> <span class="avatar">
														<img alt="" src="{{ URL::to('themes/admin/assets/img/profiles/avatar-08.jpg') }}">
													</span> </div>
				...
				<li class="nav-item dropdown has-arrow main-drop">
					<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
						<span class="user-img">
						<img src="{{ URL::to('themes/admin/assets/img/profiles/avatar-01.jpg') }}" alt="{{ helper_user_name() }}">
	...
	<!-- Datatable JS -->
	<script src="{{ URL::to('themes/admin/assets/js/jquery.dataTables.min.js') }}"></script>
	<script src="{{ URL::to('themes/admin/assets/js/dataTables.bootstrap4.min.js') }}"></script>		
	<!-- Custom JS -->
